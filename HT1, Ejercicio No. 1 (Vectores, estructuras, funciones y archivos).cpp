...
int main(){
	...
	//Menú
	cout<<"Bienvenido, favor seleccionar 1 opción del siguiente menú: "<<endl;
	cout<<"Opción 1: Ingresar datos cantidad de horas trabajadas y valor "<<endl;
	cout<<"Opción 2: Leer datos ya agregados anteriormente "<<endl;
	cout<<"Opción 3: Mostrar datos de planilla de IGSS "<<endl;
	cin>>opcion;
